...
sensorSettings.accelerometer.offsetX               =   (-0.1)/9.81*1e3;            % +-90 in mg
sensorSettings.accelerometer.offsetY               =   ( 0.1)/9.81*1e3;            % +-90 in mg
sensorSettings.accelerometer.offsetZ               =   (-0.1)/9.81*1e3;            % +-90 in mg
...
sensorSettings.gyroscope.offsetX               =   rad2deg( 0.01)*1e3;             % +-30e3 in mdps
sensorSettings.gyroscope.offsetY               =   rad2deg(-0.01)*1e3;             % +-30e3 in mdps
sensorSettings.gyroscope.offsetZ               =   rad2deg( 0.01)*1e3;             % +-30e3 in mdps
