...
sensorSettings.barometer1.noiseVariance        =   (4.5/100)^2;                     % mbar^2
...
sensorSettings.barometer2.noiseVariance        =   (4.5/100)^2;                     % mbar^2
...
sensorSettings.barometer3.noiseVariance        =   (4.5/100)^2;                      % guess in mbar
...
sensorSettings.accelerometer.noiseVariance       =   (0.202 * 1000 / 9.81)^2; % guess in mg 
...
sensorSettings.gyroscope.noiseVariance        =   (0.0019 * 1000)^2;                      % guess in mdps    100 was original
...
sensorSettings.magnetometer.noiseVariance        =   (0.0047 * 10)^2;        % guess in mgauss    original guess 2
...
sensorSettings.GPS.noiseVariance          =   [(0.0447*1e-3)^2*ones(2,1);5;(0.1/30.0)^2*ones(3,1)]; % [deg; deg; m; m/s; m/s; m/s]^2
...
sensorSettings.comb_chamber.noiseVariance        =   3.9681;                      %  mbar^2
