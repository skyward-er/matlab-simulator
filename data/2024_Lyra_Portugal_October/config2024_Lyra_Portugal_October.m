...
settings.nas.ned_mag       = wrldmagm(-settings.nas.z0,settings.nas.lat0,settings.nas.lon0,2024.70)/norm(wrldmagm(-settings.nas.z0,settings.nas.lat0,settings.nas.lon0,2024.78));
