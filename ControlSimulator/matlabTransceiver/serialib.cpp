...
/*-------------------------------------------------------------------------------*/
/* Introduced in order to solve the compile error on windows derived from the
 * inclusion of sys/time.h library (so, gettimeofday takes place of the relative
 * linux based funciton). This is not the original function, just one that is
 * said to be equivalent for windows! */
