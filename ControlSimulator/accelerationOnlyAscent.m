function acc = accelerationOnlyAscent(t, Y, settings, c, uw, vw, ww, uncert)
%{ 
...
coeffsNames = {'CA', 'CYB', 'CY', 'CNA', 'CN'};
coeffsValues = zeros(5, 1);
...
CNA = coeffsValues(4); CN0 = coeffsValues(5);
