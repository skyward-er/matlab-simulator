function [s, sensorCounter, sensorProcessed]  = initSensors(nmax)
...
s.GYRO_LSM9DS1.noiseVariance = 3000; % guess in mdps    100 was original
...
s.MAGN_LSM9DS1.noiseVariance=1000; % guess in mgauss    original guess 2
