...
switch conf.year
    ...
    case 2021
        ...
        switch conf.flight
            ...
            case "roccaraso"
                settings.mission = '2021_Lynx_Roccaraso_September';

            case "pds"
                settings.mission = '2021_Lynx_Portugal_October';
        end
    ...
    case 2022
        ...
        switch conf.flight
            ...
            case "roccaraso"
                settings.mission = '2022_Pyxis_Roccaraso_September';
    ...
    case 2024
        ...
        switch conf.flight
            ...
            case "roccaraso"
                settings.mission = '2024_Lyra_Roccaraso_September';
            
            case "pds"
                settings.mission = '2024_Lyra_Portugal_October';
