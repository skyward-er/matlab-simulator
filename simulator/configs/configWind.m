...
if conf.script == "simulator"
    ...
    switch settings.windModel
        ...
        case "multiplicative"
            ...
            settings.wind.inputAlt     = 3100/1100*[0 50 100 200 350 500 700 900 1100];       % [m] Altitude vector
            settings.wind.inputMult    = [0 1 2 3 4 4.5 5 5.5 6]*50;                 % [-] Percentage of increasing magnitude at each altitude
            settings.wind.inputAzimut  = 133*pi/180*ones(1,9);                       % [deg] Wind azimut angle at each altitude (toward wind incoming direction)
