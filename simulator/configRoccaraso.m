...
%% SIMULATION SETTINGS
settings.electronics        =   true;                                      % Switch on when testing with Hardware in the loop HIL
...
settings.PHI           =   120*pi/180;                                       %[rad] Minimum Azimuth Angle from North Direction, user input in degrees (ex. 90)
...
settings.ms                 =    19.2 - 0.810;                             % [kg]   Structural Mass
