...
contSettings.Kp    =   20.032793641963337;                    % using Fdrag nel pid --> da migliorare (magari si può ottenere variabile controllo più smooth)
contSettings.Ki    =   0.021477850634005;                     % using Fdrag nel pid
